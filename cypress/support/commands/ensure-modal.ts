...
export default function ensureModal(
  ...
  if (options.log === true) {
    log = logCommand('ensureModal', { 'Expected title': expectedTitle }, expectedTitle)
  }
...
declare global {
  namespace Cypress {
    interface Chainable {
      ensureModal(expectedTitle: string | RegExp, options?: EnsureModalOptions): Chainable<JQuery<HTMLElement>>
    }
  }
}
