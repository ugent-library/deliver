import { logCommand, updateConsoleProps, updateLogMessage } from 'support/commands/helpers'
...
export default function getTotalNumberOfFolders(): () => number {
  ...
  const containsFn = cy.now('contains', regex, { log: false }) as () => JQuery<HTMLElement>
