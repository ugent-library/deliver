...
func (fq *FileQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*File, error) {
	...
	if query := fq.withFolder; query != nil {
		if err := fq.loadFolder(ctx, query, nodes, nil,
			func(n *File, e *Folder) { n.Edges.Folder = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (fq *FileQuery) loadFolder(ctx context.Context, query *FolderQuery, nodes []*File, init func(*File), assign func(*File, *Folder)) error {
