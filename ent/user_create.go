...
func (uc *UserCreate) check() error {
	...
	if _, ok := uc.mutation.RememberToken(); !ok {
		return &ValidationError{Name: "remember_token", err: errors.New(`ent: missing required field "User.remember_token"`)}
	}
	if _, ok := uc.mutation.CreatedAt(); !ok {
...
func (u *UserUpsert) SetRememberToken(v string) *UserUpsert {
	u.Set(user.FieldRememberToken, v)
	return u
}
...
func (u *UserUpsert) UpdateRememberToken() *UserUpsert {
	u.SetExcluded(user.FieldRememberToken)
	return u
}
