...
func NewSpace(c *ctx.Ctx, space *models.Space, errs *okay.Errors) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
			...
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("\"><i class=\"if if-close\"></i> <span class=\"btn-text\">Cancel</span></a></div><div class=\"bc-toolbar-item\"><button class=\"btn btn-primary\" data-submit-target=\"#create-space\"><i class=\"if if-check\"></i> <span class=\"btn-text\">Make Space</span></button></div></div></div></div><div class=\"card-body\"><form action=\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			if e := errs.Get("name"); e != nil {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `new_space.templ`, Line: 54, Col: 99}
				}
